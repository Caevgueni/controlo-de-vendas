 ...
 * @author itais
 */
public class FrmTotaldaVendaPorDia extends javax.swing.JFrame {

    /**
     * Creates new form DetalhesDavenda
     */
    public FrmTotaldaVendaPorDia() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Total da venda por dia");
    ...
    private void btnconsultapordataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnconsultapordataActionPerformed
        ...
        try {
            // botao calcular o total da venda ppor data
            ...
            total_venda = dao.retonarTotalVendaPorData(data_venda);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmTotaldaVendaPorDia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmTotaldaVendaPorDia().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    public javax.swing.JButton btnconsultapordata;
