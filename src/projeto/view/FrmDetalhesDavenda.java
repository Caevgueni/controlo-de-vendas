 ...
 * @author itais
 */
public class FrmDetalhesDavenda extends javax.swing.JFrame {

    /**
     * Creates new form DetalhesDavenda
     */
    public FrmDetalhesDavenda() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDetalhesDavenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmDetalhesDavenda().setVisible(true);
            }
        });
    }
